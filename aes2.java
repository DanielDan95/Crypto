...
public class aes2 {
        ...
        for(int i=0; i< word.length; i++){
            for(int j=0; j<word.length; j++){
                ...
                if(hex.length() == 1){
                    ...
                    row = Integer.parseInt(hex.substring(hex.length()-2, hex.length()-1), 16);
                    col = Integer.parseInt(hex.substring(hex.length()-1), 16);
                }
    ...
    public static void main(String[] args){
        ...
        //byte[] byteArr = AESutils.readFile("plain.in");
